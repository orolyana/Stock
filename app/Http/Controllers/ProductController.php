    ...
    public function loadProducts(Request $request){
        ...
        try{
            ...
            foreach($productList as $key => &$value){
                $amount = round($value["quantity"] * $value["pricePerItem"],2);
    ...
    public function saveProduct(Request $request)
{
    ...
    try {
        ...
        if ($validator->fails()) {
            ...
            $Product->pricePerItem = $data["pricePerItem"];
            ...
            File::put(public_path('/json_files/' . $fileName), json_encode($Product)); // Ensure proper JSON encoding
